...
\newcommand{\documentBackground}{../../CORE/Background/document-background-print.png}
...
\begin{document}
	...
	\newpage
	\include{sections/understanding_applying_standard}

	\newpage
	\include{sections/structure_organization_implementation}

	\newpage
	\include{sections/system_context_processes}

	\newpage
	\include{sections/software_specific_processes}


	\newpage
	\appendix 

	\include{sections/lower_level_processes}

	\newpage
	\include{sections/process_views}

	\newpage
	\include{sections/relationships_between_standards}

	\newpage
	\include{sections/tailoring_process}
